...
import { applyLang, refreshMenu, refreshInspector, refreshEvolution, refreshChallenge, show } from './ui.js';
...
function frame(){
  ...
  draw(); drawCharts(); updateHUD(); refreshInspector(); refreshEvolution(); refreshChallenge();
